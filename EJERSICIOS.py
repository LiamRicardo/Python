...
#cidade = "São Paulo"
#print(f"{cidade} e Rio de Janeiro")
...
#ACTIVIDADE 5
#pal = "A vida e uma poja caralio me cago en todo"
#pol = "AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA joder"
#print(f"{pal} {pol}")
...
#Tipos de Datos (int)Enetro,(str)Stringe,(float) .(type)
...
#ACTIVIDADE 11
#capital = float(input("Cololque seu capital innical: R$"))
#juros = float(input("Coloque a taxa de juros: R$"))
